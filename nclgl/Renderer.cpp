...
Renderer::Renderer(Window &parent) : OGLRenderer(parent)	{
	...
	brickTex = LoadTexture("brick.png");
	glTextureParameteri(brickTex, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
	glTextureParameteri(brickTex, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
	staticTex = LoadTexture("noise.png");
	glTextureParameteri(staticTex, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
	glTextureParameteri(staticTex, GL_TEXTURE_WRAP_T, GL_REPEAT);
